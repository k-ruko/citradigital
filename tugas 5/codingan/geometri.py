...
images= [
         ...
         cv2.imread("F:/semester5/citra digital/tugas 5/4143d2a7-28d9-429b-8060-9b4a496e22ef (1).jfif")]
...
closeIterations = [25, 10]
openIterations = [19, 12]
...
kmDistance = pixelDistance / 0.6409090909090909 # 40 px / 1km
...
cv2.putText(images[0], f'd = {kmDistance} m', getCenterofLine(centers[0], centers[1], y=-20), cv2.FONT_HERSHEY_DUPLEX, 0.5, (255, 0, 255), 1)
